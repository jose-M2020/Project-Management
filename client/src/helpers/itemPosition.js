...
export const getInsertedItemPos = (items, targetIndex) => {
  ...
  const leftAdjacentItemPos = items[targetIndex - 1].order;
  const rightAdjacentItemPos = items[targetIndex + 1].order;
