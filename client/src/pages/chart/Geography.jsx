...
import { GET_COMPANYLOCATIONS } from '../../graphql/queries/projectQueries';
...
const Geography = () => {
  ...
  const { loading, error, data } = useQuery(GET_COMPANYLOCATIONS);
                ...
                effects: [
                  {
                    on: "hover",
                    style: {
                      itemTextColor: colors.blueAccent[100],
                      itemOpacity: 1,
                    },
                  },
                ],
